...
def main():
    ...
    print(f"  - All 30 terms are meaningful (stopwords removed)")
    print(f"  - Better insights for researchers and policymakers")
    
    # Show examples of removed stopwords
    if len(old_stopwords) > 0:
        print(f"\nExamples of stopwords removed:")
        for idx, row in old_stopwords.head(10).iterrows():
